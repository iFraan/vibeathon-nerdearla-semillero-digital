	...
	const allAssignments: AssignmentWithDetails[] = [
		{
			...
			description:
				"Create functions to solve common programming problems using ES6+ syntax",
		...
		},
		{
			...
			description:
				"Build a weather app using React hooks and component composition",
		...
		},
		{
			...
			description:
				"Multiple choice quiz covering normalization and entity relationships",
		...
		},
		{
			...
			description:
				"Create a responsive portfolio website using modern CSS techniques",
			dueDate: new Date(baseDate.getTime() - 2 * 24 * 60 * 60 * 1000),
			maxPoints: 120,
			courseName: "Web Development",
			teacherName: "Prof. Ana García",
		...
		},
		{
			...
			description:
				"Implement Redux Toolkit for state management in a todo application",
