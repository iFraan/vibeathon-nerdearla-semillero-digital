...
export const PERMISSIONS: RolePermissions = {
  student: [
    ...
    { resource: "submissions", action: "view", conditions: { ownSubmissions: true } },
    { resource: "grades", action: "view", conditions: { ownGrades: true } },
    { resource: "notifications", action: "view", conditions: { ownNotifications: true } },
    { resource: "notifications", action: "markAsRead", conditions: { ownNotifications: true } },
  ...
  teacher: [
    ...
    { resource: "assignments", action: "edit", conditions: { ownCourse: true } },
    { resource: "assignments", action: "delete", conditions: { ownCourse: true } },
    { resource: "submissions", action: "view", conditions: { ownCourse: true } },
    { resource: "submissions", action: "grade", conditions: { ownCourse: true } },
    ...
    { resource: "notifications", action: "create", conditions: { ownCourse: true } },
    { resource: "notifications", action: "markAsRead", conditions: { ownNotifications: true } },
    ...
    { resource: "classManagement", action: "view", conditions: { ownCourse: true } },
  ],
  coordinator: [
    { resource: "dashboard", action: "view" },
    { resource: "profile", action: "view" },
...
export interface AuthUtilities {
  checkPermission: (user: AuthUser, resource: string, action: string, context?: any) => boolean;
...
export interface UsePermissionsReturn {
  ...
  checkMultiple: (permissions: { resource: string; action: string; context?: any }[]) => boolean[];
}
